package br.edu.PDI;
	...
	************************************************/
	...
	/*private Mat image;
	double realOut[][], complexOut[][];
	double realImage[][];
	TwoD_FFT tdfft = new TwoD_FFT();
	public LeituraImagem2() {
		this.image = Imgcodecs.imread("Images/images.jpg");
		this.realImage = (double[][])image;
	}
	public void startfourier() {
		tdfft.twoDfft(image, realOut, complexOut);
	}*/
